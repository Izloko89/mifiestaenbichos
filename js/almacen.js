...
$(document).ready(function(e) {
	...
	$("#modifica").click( function(e){
		...
		art = $("#id_art").val();
		$.ajax({
			url:'scripts/modificaAlmacen.php',
			cache:false,
			type:'POST',
			data:{
				'cant':cant,
	...
	$(".id_articulo").change(function (e){
		$("#id_art").val($(this).val());
	});
	$(".id_articulo_salida").change(function (e){
		$("#id_art_salida").val($(this).val());
	});
	...
	$(".b_entrada").click(function(e) {
		...
		cant = $(".cantidad_salida").val(); 
		art = $("#id_art_salida").val();
		$.ajax({
			url:'scripts/modificaAlmacenSalida.php',
			cache:false,
			type:'POST',
			data:{
				'cant':cant,
