...
<div class="wrapper tabla">
 	<div id="topbar">
    	<div align="center">
		  ...
		  <?php
		  if($_SESSION["categoria"] != "empleados")
	{ ?>
            <div id="nav_bar">
	...
	<?php } else { ?>
	  <div id="nav_bar">
          <!--    <span class="celda link" data-url="home.php">INICIO</span> -->
			 ...
			 if(pagina != "http://admin.gumpy.com.mx/modulos.php" )
			 {
				 window.location = "http://admin.gumpy.com.mx/modulos.php"
			 }
