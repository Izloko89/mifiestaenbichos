  ...
  <input type="hidden" name="id" class="id" />
    ...
    <div class="campo_form">
     ...
     <div class="campo_form">
        ...
        <input type="text" name="pcompra" id="pcompra" class="pcompra">
    </div>
     <div class="campo_form">
        <label class="label_width">Precio de venta</label>
        <input type="text" name="pventa" id="pventa" class="pventa">
    </div>
</form>
</td>
<td >
...
<h3 class="titulo_form">Listado de empleados registrados</h3>
    ...
    <?php if(count($clientes)>0){foreach($clientes as $art=>$d){
		...
		echo '<td>'.$d["nombre"].'</td>';
		echo '<td><img src="../img/cruz.png" height="20" onclick="eliminar();" /></td>';
		echo '</tr>';
...
{
var aidi = document.getElementById("clave").value;
